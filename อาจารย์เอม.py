...
sets = {
    "l":True, 
      "c":True, 
      "cm":"AUTO LIKE FOR : ★เทพอาจารย์เอม★",  
    "winvite": False,
    "wblacklist": False,
    "tagsticker": False,
    "Sticker": False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " ★เทพอาจารย์เอม★ ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ue846139824ec13384cbb921b460323ac"}}
                    sendTemplate(to,data)
...
{
"text": "  is bot line ★เทพอาจารย์เอม★ ",
"size": "xs",
"margin": "none",
"color": "#00F5FF",
"wrap": True,
...
#=====================================================================                
                ...
                elif text.lower() == 'speed':start = time.time();maxgie.sendMessage("ue846139824ec13384cbb921b460323ac", "★เทพอาจารย์เอม★ ");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                        ...
                        maxgie.datamention(to,'★เทพอาจารย์เอม★ ',nama)
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                  ...
                  #  
                    maxgie.unsendMessage(msg_id)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    maxgie.sendMessage(to, maxgie.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+maxgie.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "★เทพอาจารย์เอม★ ", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '★เทพอาจารย์เอม★ ', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
